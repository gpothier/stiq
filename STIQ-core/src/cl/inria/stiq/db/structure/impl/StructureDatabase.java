...
import cl.inria.stiq.db.structure.IAdviceInfo;
import cl.inria.stiq.db.structure.IArrayTypeInfo;
import cl.inria.stiq.db.structure.IAspectInfo;
import cl.inria.stiq.db.structure.IBehaviorInfo;
import cl.inria.stiq.db.structure.IBehaviorInfo.BytecodeRole;
import cl.inria.stiq.db.structure.IClassInfo;
import cl.inria.stiq.db.structure.IClassInfo.Bytecode;
import cl.inria.stiq.db.structure.IFieldInfo;
import cl.inria.stiq.db.structure.IMutableBehaviorInfo;
import cl.inria.stiq.db.structure.IMutableFieldInfo;
import cl.inria.stiq.db.structure.IMutableStructureDatabase;
import cl.inria.stiq.db.structure.IShareableStructureDatabase;
import cl.inria.stiq.db.structure.IStructureDatabase;
import cl.inria.stiq.db.structure.ITypeInfo;
import cl.inria.stiq.db.structure.SourceRange;
import cl.inria.stiq.instrumenter.BCIUtils;
import cl.inria.stiq.tools.parsers.ParseException;
import cl.inria.stiq.tools.parsers.workingset.WorkingSetFactory;
