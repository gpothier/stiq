...
*/
package cl.inria.stiq.db.file.classic;
...
import cl.inria.stiq.db.file.classic.ClassicPagedFile.FilePage;
...
public class BufferManager
{
	...
	{
		itsPageSize = DBConfig.DB_PAGE_SIZE;
		itsBufferCount = (int) (DBConfig.DB_PAGE_BUFFER_SIZE/DBConfig.DB_PAGE_SIZE);
...
//			System.out.println("updateUsage executed in "+t+"ms.");
	...
	{
		public final FixedIntStack useStack = new FixedIntStack(DBConfig.DB_TASK_SIZE);
		public final FixedIntStack freeStack = new FixedIntStack(DBConfig.DB_TASK_SIZE);
	}
}
